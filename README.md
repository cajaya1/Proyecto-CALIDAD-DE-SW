# Tennis Store - Tienda de Tenis Online
...
- ✅ **Chatbot con IA** para asistencia al cliente
- ✅ **Sistema de reseñas** de productos
- ✅ **Sistema de reservaciones** de productos
- ✅ **Interfaz responsive** moderna
- ✅ **API RESTful** bien estructurada
- ✅ **Base de datos MySQL** normalizada
- ✅ **Tests de calidad ISO 25022** integrados
...
## 📊 Tests de Calidad ISO 25022

El proyecto incluye un conjunto completo de pruebas de calidad en uso basadas en el estándar **ISO/IEC 25022:2016**.

### 🎯 Categorías Evaluadas
- **Efectividad**: ¿Los usuarios pueden completar sus tareas?
- **Eficiencia**: ¿El sistema responde rápido y maneja bien la carga?
- **Satisfacción**: ¿Los usuarios están satisfechos?
- **Ausencia de Riesgo**: ¿El sistema es seguro y confiable?
...
# Ejecutar tests y ver reporte HTML
...
**📖 Documentación completa**: [TESTS_ISO25022.md](TESTS_ISO25022.md)

**📂 Ubicación**: `iso25022-tests/`

**📊 Reporte**: `iso25022-tests/reports/iso25022-report.html`

### Métricas Evaluadas (26+ métricas)
- ✅ 8 tareas principales del sistema
- ✅ 5 operaciones de eficiencia
- ✅ 7 funcionalidades de usuario
